...
const getDefaultProducts = (): Product[] => [
  { id: '1', name: 'Bier / Pils / Radler', price: 3.50, deposit: 2.00 },
  { id: '2', name: 'Schnaps', price: 4, deposit: 2.00 },
  { id: '3', name: 'Narrenbecher', price: 6, deposit: 0.00 },
  { id: '4', name: 'Flasche Sekt', price: 13, deposit: 2.00 },
  { id: '5', name: 'Cola / Fanta / Spezi / Apfel', price: 3, deposit: 2.00 },
  { id: '6', name: 'Wasser', price: 2.50, deposit: 2.00 },
];
